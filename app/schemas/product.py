...
class ProductCreate(BaseModel):
    ...
    price: float = Field(..., gt=0, le=10000, description="Product price (must be positive, max $10,000)")
...
class ProductSearchParams(BaseModel):
    query: Optional[str] = Field(None, description="Search query for title, description, or tags")
    ...
    sort_by: Optional[str] = Field("created_at", description="Sort field: created_at, price, title")
